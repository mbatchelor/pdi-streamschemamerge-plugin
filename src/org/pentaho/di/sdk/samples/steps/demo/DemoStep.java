...
public class DemoStep extends BaseStep implements StepInterface {
	...
	public boolean init(StepMetaInterface smi, StepDataInterface sdi) {
		...
		this.meta = (DemoStepMeta) smi;
		this.data = (DemoStepData) sdi;
	...
	public boolean processRow(StepMetaInterface smi, StepDataInterface sdi) throws KettleException {
		...
		if (first) {
            ...
            data.tMapping = new TransformMapping(data.rowMetas, TransformMapping.SchemaMergeType.UNION);
